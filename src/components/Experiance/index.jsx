...
const Experiance = () => {
    ...
    return (
        <div className="ExpContainer">
            <div className="skillheading">Experiance</div>
            <div className="EContent">
                ...
                <div className="expdetails">
                    ...
                    <div className="expcont">
                        <div>
                            <span className="line1" style={{ lineHeight: '1rem', padding: '5px', marginLeft: '-15px' }}>
                                Credit Suisse (UBS) :
                            </span>
                            <span>
                                June 2022 - now
                        ...
                        <div>
                            <pre style={{ textAlign: "justify" }} >{data}</pre>
                            <div>
                                <span className="line1" style={{ lineHeight: '1.2rem', padding: '0px', marginRight:'5px' }}>
                                    Tech Stack :
                                </span>
                                 Java, Spring Boot, Oracle, React, C#, .NET, APIs, Microservices, Pub/Sub Docker Agile, CI/CD.
                            </div>
                        </div>
                    ...
                    <div className="expcont">
                        <span className="line1" style={{ lineHeight: '1rem', padding: '5px 20px 5px 5px', marginLeft: '-15px', position: 'relative' }}>
                            Next Adventure
